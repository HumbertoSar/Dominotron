...
import { validateVocabulary } from '../../engine/index'
...
describe('vocabulario (semente do T5)', () => {
  it('o pool portavel le todas as tags declaradas, sem orfaos nem refs invalidas', () => {
    const report = validateVocabulary(dominoBoard.declareTagVocabulary(), DOMINO_POOL_PORTABLE)
